...
<meta charset="utf-8" />
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
                ...
                <img src="IMG/kkkk.png" align="right" width="150" >
       ...
       <div class="txt" >    &emsp;&emsp; محفظتي <br>     My Wallet  (ET)  </div>
        ...
        <button  type="submit" value="sign up"><a href="deleteuser.php">حدف الحساب</a> </button>
        </div>
         <br>
         ...
         <nav><center> 
          ...
          <button  type="submit" > <a href="addcategory.php" target="_self"> إضافة فئة </a></button>&emsp; |&emsp;
          ...
          <button  type="submit" > <a href="https://topup.almadar.ly/ar/ppi/index.php" target="_self"> طباعة فاتورة</a></button>&emsp; |&emsp;
          </div>  </h3></center>
      </nav> <br>
        </div>  
